...
<form class="form-inline" role="form">
    ...
    <div class="form-group has-success has-feedback">
        ...
        <input class="form-control" id="suppliername" type="text"placeholder="Enter Name">
    </div>
</form>
</br>
</br>
...
<form class="form-inline" role="form">
    ...
    <div class="form-group has-success has-feedback">
        ...
        <input class="form-control" id="supplierphone" type="text"placeholder="Enter Phone Number">
    </div>
</form>
...
<form class="form-inline" role="form">
    ...
    <div class="form-group has-success has-feedback">
        ...
        <input class="form-control" id="supplieremail" type="text"placeholder="Enter Email Address">
    </div>
</form>
