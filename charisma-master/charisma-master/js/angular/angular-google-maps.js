    ...
    (function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmap_sync", [function () {
                ...
                return v = b.promiseTypes, o = b.isInProgress, u = b.promiseStatus, g = b.ExposedPromise, i = b.SniffedPromise, p = function (a, b) {
                    ...
                    var d, f;
                    if (a.existingPieces) {
                        if (d = _.last(a.existingPieces._content), l(b, d))
                            return;
                ...
                }, j = 80, n = {value: null}, w = function (a, b, c) {
                    var d;
                    try {
                        return a.apply(b, c)
                    } catch (e) {
                    ...
                    var i, j, l;
                    for (i = c && c < b.length?c:b.length, j = h, l = !0; l && i-- && j < (b?b.length:j + 1); )
                        l = q(e, void 0, g, [b[j], j]), ++j;
                    if (b) {
                        if (!(l && j < b.length))
                            return g.resolve();
                        if (h = j, c)
                            return null != f && _.isFunction(f) && q(f, void 0, g, []), a(function () {
                ...
                }, {each: m, map: s, managePromiseQueue: r, promiseLock: r, defaultChunkSize: j, chunkSizeFrom: function (a) {
                        var b;
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapEventsHelper", ["uiGmapLogger", function () {
                return{setEvents: function (a, c, d, e) {
                        return b.isDefined(c.events) && null != c.events && b.isObject(c.events) ? _.compact(_.map(c.events, function (f, g) {
                            ...
                            return e && (h = _(e).contains(g)), c.events.hasOwnProperty(g) && b.isFunction(c.events[g]) && !h ? google.maps.event.addListener(a, g, function () {
                                return c.$evalAsync || (c.$evalAsync = function () {
                                }), c.$evalAsync(f.apply(c, [a, g, d, arguments]))
                            }) : void 0
                        })) : void 0
        ...
        var a = {}.hasOwnProperty, c = function (b, c) {
            function d() {
                this.constructor = b
            }
            for (var e in c)
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapGmapUtil", ["uiGmapLogger", "$compile", function (a, c) {
                ...
                return e = function (a) {
                    ...
                    return a && b.isDefined((null != a ? a.latitude : void 0) && b.isDefined(null != a ? a.longitude : void 0)) ? !0 : !1
                    ...
                    }, getCoords: d, validateCoords: g, equalCoords: function (a, b) {
                        ...
                        if (d = 0, b.isUndefined(a.type)) {
                            if (!Array.isArray(a) || a.length < 2)
                                return!1;
                            for (; d < a.length; ) {
                                if (!(b.isDefined(a[d].latitude) && b.isDefined(a[d].longitude) || "function" == typeof a[d].lat && "function" == typeof a[d].lng))
                                    return!1;
                                d++
                            }
                            return!0
                        ...
                        if ("Polygon" === a.type) {
                            ...
                            }, f), e = a.coordinates[f.index], c = e[0], c.length < 4)
                                return!1
                        } else {
                        ...
                        if (d = 0, f = new google.maps.MVCArray, b.isUndefined(a.type))
                            for (; d < a.length; )
                                b.isDefined(a[d].latitude) && b.isDefined(a[d].longitude) ? e = new google.maps.LatLng(a[d].latitude, a[d].longitude) : "function" == typeof a[d].lat && "function" == typeof a[d].lng && (e = a[d]), f.push(e), d++;
                        else
                            for ("Polygon" === a.type?c = a.coordinates[0]:"MultiPolygon" === a.type?(g = {max:0, index:0}, _.forEach(a.coordinates, function (a, b) {
                                return a[0].length > this.max ? (this.max = a[0].length, this.index = b) : void 0
                            }, g), c = a.coordinates[g.index][0]):"LineString" === a.type && (c = a.coordinates); d < c.length; )
                                f.push(new google.maps.LatLng(c[d][1], c[d][0])), d++;
                        return f
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapLogger", ["$log", function (a) {
                var b, c, d, e;
                return this.doLog = !0, b = {log: 1, info: 2, debug: 3, warn: 4, error: 5, none: 6}, e = function (a, b, c) {
                    return a >= b ? c() : void 0
                }, c = function (b, c) {
        ...
        }, c = {}.hasOwnProperty, d = function (a, b) {
            function d() {
                this.constructor = a
            }
            for (var e in b)
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapModelKey", ["uiGmapBaseObject", "uiGmapGmapUtil", "uiGmapPromise", "$q", "$timeout", function (b, c) {
                ...
                return e = function (b) {
                    ...
                    return d(e, b), e.prototype.evalModelHandle = function (a, b) {
                        ...
                        var d;
                        if (d = null != this.scope.coords ? this.scope : this.parentScope, null == d)
                        ...
                        for (f in a)
                            b && b[f] === a[f] || (_.isArray(a[f]) ? e[f] = a[f] : _.isObject(a[f]) ? (d = this.getChanges(a[f], b ? b[f] : null), _.isEmpty(d) || (e[f] = d)) : e[f] = a[f]);
                        return e
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapModelsWatcher", ["uiGmapLogger", "uiGmap_async", "$q", "uiGmapPromise", function (a, b, c, d) {
                return{didQueueInitPromise: function (a, c) {
                        ...
                        return f = [], h = {}, i = [], j = [], c.models.forEach(function (c) {
                            var g;
                            return null == c[b] ? a.error(" id missing for model #{m.toString()},\ncan not use do comparison/insertion") : (h[c[b]] = {}, null == d.get(c[b]) ? f.push(c) : (g = d.get(c[b]), e(c, g.clonedModel) ? void 0 : j.push({model: c, child: g})))
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapPromise", ["$q", "$timeout", "uiGmapLogger", function (a, b, c) {
                ...
                return l = {create: "create", update: "update", "delete": "delete", init: "init"}, k = {IN_PROGRESS: 0, RESOLVED: 1, REJECTED: 2}, n = function () {
                    var a;
                ...
                }, {defer: f, promise: i, resolve: m, promiseTypes: l, isInProgress: g, isResolved: h, promiseStatus: j, ExposedPromise: d, SniffedPromise: e}
            }])
    }.call(this), function () {
                ...
                return g = function (e) {
                    ...
                    return d(g, e), g.type = "ClustererMarkerManager", g.prototype.checkKey = function (a) {
                        ...
                        if (b.isDefined(a) && null != a && b.isObject(a)) {
                            g = [];
                            for (f in a)
                                e = a[f], a.hasOwnProperty(f) && b.isFunction(a[f]) ? (c.info("" + d + ": Attaching event: " + f + " to clusterer"), g.push(google.maps.event.addListener(this.clusterer, f, a[f]))) : g.push(void 0);
                            return g
                        }
                        ...
                        if (b.isDefined(a) && null != a && b.isObject(a)) {
                            f = [];
                            for (e in a)
                                d = a[e], a.hasOwnProperty(e) && b.isFunction(a[e]) ? (c.info("" + optionsName + ": Clearing event: " + e + " to clusterer"), f.push(google.maps.event.clearListeners(this.clusterer, e))) : f.push(void 0);
                            return f
                        }
        ...
        b.module("uiGmapgoogle-maps").factory("uiGmaparray-sync", ["uiGmapadd-events", function (a) {
                return function (c, d, e, f) {
                    ...
                    return j = !1, n = d.$eval(e), d["static"] || (k = {set_at: function (a) {
                            var b;
                            if (!j && (b = c.getAt(a)))
                                return b.lng && b.lat ? (n[a].latitude = b.lat(), n[a].longitude = b.lng()) : n[a] = b
                        }, insert_at: function (a) {
                            var b;
                            if (!j && (b = c.getAt(a)))
                                return b.lng && b.lat ? n.splice(a, 0, {latitude: b.lat(), longitude: b.lng()}) : n.splice(a, 0, b)
                        }, remove_at: function (a) {
                            return j ? void 0 : n.splice(a, 1)
                        }}, "Polygon" === n.type ? g = n.coordinates[0] : "LineString" === n.type && (g = n.coordinates), h = {set_at: function (a) {
                            var b;
                        ...
                        var b, d, e, g, h, i, k, l;
                        if (j = !0, i = c, b = !1, a) {
                            for (d = 0, k = i.getLength(), g = a.length, e = Math.min(k, g), h = void 0; e > d; )
                                l = i.getAt(d), h = a[d], "function" == typeof h.equals ? h.equals(l) || (i.setAt(d, h), b = !0) : (l.lat() !== h.latitude || l.lng() !== h.longitude) && (i.setAt(d, new google.maps.LatLng(h.latitude, h.longitude)), b = !0), d++;
                            for (; g > d; )
                                h = a[d], i.push("function" == typeof h.lat && "function" == typeof h.lng ? h : new google.maps.LatLng(h.latitude, h.longitude)), b = !0, d++;
                            for (; k > d; )
                                i.pop(), b = !0, d++
                        }
                        ...
                        if (j = !0, k = c, d = !1, a) {
                            for ("Polygon" === n.type?b = a.coordinates[0]:"LineString" === n.type && (b = a.coordinates), e = 0, l = k.getLength(), h = b.length, g = Math.min(l, h), i = void 0; g > e; )
                                m = k.getAt(e), i = b[e], (m.lat() !== i[1] || m.lng() !== i[0]) && (k.setAt(e, new google.maps.LatLng(i[1], i[0])), d = !0), e++;
                            for (; h > e; )
                                i = b[e], k.push(new google.maps.LatLng(i[1], i[0])), d = !0, e++;
                            for (; l > e; )
                                k.pop(), d = !0, e++
                        }
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapChromeFixes", ["$timeout", function (a) {
                return{maybeRepaint: function (b) {
        ...
        b.module("uiGmapgoogle-maps.directives.api.options.builders").service("uiGmapCommonOptionsBuilder", ["uiGmapBaseObject", "uiGmapLogger", "uiGmapModelKey", function (c, e, f) {
                ...
                return g = function (c) {
                    ...
                    return d(f, c), f.prototype.props = ["clickable", "draggable", "editable", "visible", {prop: "stroke", isColl: !0}], f.prototype.buildOpts = function (a, c) {
                        var d, f, g;
                        return null == a && (a = {}), null == c && (c = {}), this.scope ? this.map ? (d = this.hasModel ? this.scope.model : this.scope, g = this.scopeOrModelVal("stroke", this.scope, d), f = b.extend(a, this.DEFAULTS, {map: this.map, strokeColor: null != g ? g.color : void 0, strokeOpacity: null != g ? g.opacity : void 0, strokeWeight: null != g ? g.weight : void 0}), b.forEach(b.extend(c, {clickable: !0, draggable: !1, editable: !1, "static": !1, fit: !1, visible: !0, zIndex: 0, icons: []}), function (a) {
                            return function (c, e) {
                                var g;
        ...
        b.module("uiGmapgoogle-maps.directives.api.options.builders").factory("uiGmapPolylineOptionsBuilder", ["uiGmapCommonOptionsBuilder", function (a) {
                ...
                return b = function (a) {
                    ...
                    return c(b, a), b.prototype.buildOpts = function (a) {
                        return b.__super__.buildOpts.call(this, {path: a}, {geodesic: !1})
                    }, b
                }(a)
                ...
                return d = function (a) {
                    ...
                    return c(d, a), d.prototype.buildOpts = function (a, c) {
                        var e, f;
                        return f = this.hasModel ? this.scope.model : this.scope, e = this.scopeOrModelVal("fill", this.scope, f), a = b.extend(a, {fillColor: null != e ? e.color : void 0, fillOpacity: null != e ? e.opacity : void 0}), d.__super__.buildOpts.call(this, a, c)
                    }, d
                }(a)
                ...
                return b = function (a) {
                    ...
                    return c(b, a), b.prototype.buildOpts = function (a) {
                        return b.__super__.buildOpts.call(this, {bounds: a})
                    }, b
                }(a)
                ...
                return b = function (a) {
                    ...
                    return c(b, a), b.prototype.buildOpts = function (a, c) {
                        return b.__super__.buildOpts.call(this, {center: a, radius: c})
                    }, b
                }(a)
            }])
    }.call(this), function () {
        b.module("uiGmapgoogle-maps.directives.api.options").service("uiGmapMarkerOptions", ["uiGmapLogger", "uiGmapGmapUtil", function (a, c) {
                return _.extend(c, {createOptions: function (a, d, e, f) {
                        var g;
                        return null == e && (e = {}), g = b.extend({}, e, {position: null != e.position ? e.position : c.getCoords(a), visible: null != e.visible ? e.visible : c.validateCoords(a)}), (null != e.icon || null != d) && (g = b.extend(g, {icon: null != e.icon ? e.icon : d})), null != f && (g.map = f), g
                    }, isLabel: function (a) {
                ...
                return function (c, e) {
                    ...
                    return i = function (c) {
                        function i(c, d, g, i, j) {
                            var k;
                            this.scope = c, this.attrs = d, this.map = g, this.defaults = i, this.model = j, this.clean = a(this.clean, this), this.clonedModel = _.clone(this.model, !0), this.isDragging = !1, this.internalEvents = {dragend: function (a) {
                                    return function () {
                                ...
                                return function () {
                                    var b;
                                    if (!a.isDragging)
                                        return b = a.convertPathPoints(a.scope.path), null != a.shape && a.clean(), b.length > 0 && (a.shape = e(a.buildOpts(b))), a.shape ? (a.scope.fit && a.extendMapBounds(g, b), f(a.shape.getPath(), a.scope, "path", function (b) {
                                            return a.scope.fit ? a.extendMapBounds(g, b) : void 0
                                        }), a.listeners = a.model ? a.setEvents(a.shape, a.scope, a.model) : a.setEvents(a.shape, a.scope, a.scope), a.internalListeners = a.model ? a.setEvents(a.shape, {events: a.internalEvents}, a.model) : a.setEvents(a.shape, {events: a.internalEvents}, a.scope)) : void 0
                                }
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.child").factory("uiGmapDrawFreeHandChildModel", ["uiGmapLogger", "$q", function (a, b) {
                ...
                return c = function (a, b, c) {
                    var d, e;
                    return e = new google.maps.Polyline({map: a, clickable: !1}), d = google.maps.event.addListener(a, "mousemove", function (a) {
                    ...
                    var f, g;
                    return this.map = d, e || (e = {draggable: !0, zoomControl: !0, scrollwheel: !0, disableDoubleClickZoom: !0}), g = function (a) {
                        return function () {
                            var b;
                        ...
                        return function () {
                            return a.info("disabling map move"), b.oldOptions = d.getOptions(), b.oldOptions.center = d.getCenter(), b.map.setOptions({draggable: !1, zoomControl: !1, scrollwheel: !1, disableDoubleClickZoom: !1})
                        }
                ...
                return m = ["coords", "icon", "options", "fit"], l = function (b) {
                    ...
                    return d(l, b), l.include(c), l.include(f), l.include(h), m = function (a) {
                        ...
                        if (null == a && (a = !0), c = this.getProp(this.coordsKey, this.model), null != c) {
                            if (!this.validateCoords(c))
                                return void e.debug("MarkerChild does not have coords yet. They may be defined later.");
                            if (null != b && b(), a && this.gMarker)
                                return this.gMarkerManager.add(this.gMarker)
                        } else if (a && this.gMarker)
                        ...
                        switch (null == c && (c = void 0), null == d && (d = !1), null == e && (e = !0), null == b ? b = this.model : this.model = b, this.gMarker || (this.setOptions(this.scope, e), f = !0), a) {
                            ...
                            case"options":
                                if (!f)
                                    return this.createMarker(b, c, d, e)
                            }
                    ...
                    return e(m, d), m.include(f), m.include(l), m.prototype.doShow = function () {
                        ...
                        return this.scope.$watch(function (a) {
                            return function () {
                                var b, c;
                                if (a.element || a.html)
                                    return a.html !== a.element.html() && a.gWin ? (null != (c = a.opts) && (c.content = void 0), b = a.gWin.isOpen(), a.remove(), a.createGWin(b)) : void 0
                            }
                        }(this))
                            ...
                            return function (b, c) {
                                ...
                                if (b !== c) {
                                    if (null == b)
                                        ...
                                        return void g.error("WindowChildMarker cannot render marker as scope.coords as no position on marker: " + JSON.stringify(a.model));
                        ...
                        var b, c;
                        if (null != this.gWin)
                            return c = this.getGmarker(), b = function (a) {
                                return function () {
                        ...
                        return null != this.gWin ? (c = function (a) {
                            return function () {
                                var b, c, d;
                                if (!a.gWin.isOpen()) {
                                    if (c = a.getGmarker(), null != a.gWin && null != a.gWin.getPosition && (d = a.gWin.getPosition()), c && (d = c.getPosition()), !d)
                                        return;
                                    if (a.gWin.open(a.mapCtrl, c), b = a.gWin.isOpen(), a.model.show !== b)
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapCircleParentModel", ["uiGmapLogger", "$timeout", "uiGmapGmapUtil", "uiGmapEventsHelper", "uiGmapCircleOptionsBuilder", function (a, d, e, f, g) {
                ...
                return h = function (d) {
                    function g(c, d, f, g, h) {
                        ...
                        }(this), this.props = this.props.concat([{prop: "center", isColl: !0}, {prop: "fill", isColl: !0}, "radius"]), this.watchProps(), j = this.setEvents(i, c, c), google.maps.event.addListener(i, "radius_changed", function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapIMarkerParentModel", ["uiGmapModelKey", "uiGmapLogger", function (c, e) {
                ...
                return f = function (c) {
                    function f(c, d, g, h) {
                        if (this.scope = c, this.element = d, this.attrs = g, this.map = h, this.onDestroy = a(this.onDestroy, this), this.onWatch = a(this.onWatch, this), this.watch = a(this.watch, this), this.validateScope = a(this.validateScope, this), f.__super__.constructor.call(this, this.scope), this.$log = e, !this.validateScope(c))
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMarkersParentModel", ["uiGmapIMarkerParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapMarkerChildModel", "uiGmap_async", "uiGmapClustererMarkerManager", "uiGmapMarkerManager", "$timeout", "uiGmapIMarker", "uiGmapPromise", "uiGmapGmapUtil", "uiGmapLogger", function (c, e, f, g, h, i, j, k, l, m, n) {
                ...
                return o = function (c) {
                    function k(b, c, d, e) {
                        ...
                        var g;
                        k.__super__.constructor.call(this, b, c, d, e), g = this, this.scope.markerModels = new f, this.scope.markerModelsUpdate = {updateCtr: 0}, this.$log.info(this), this.doRebuildAll = null != this.scope.doRebuildAll ? this.scope.doRebuildAll : !1, this.setIdKey(b), this.scope.$watch("doRebuildAll", function (a) {
                            return function (b, c) {
                    ...
                    return d(k, c), k.include(n), k.include(e), k.prototype.onWatch = function (a, b, c, d) {
                        ...
                        if (a.doRebuild || void 0 === a.doRebuild)
                            return(null != (b = this.scope.markerModels) ? b.length : void 0) ? this.onDestroy(a).then(function (b) {
                                return function () {
                        ...
                        var b, c;
                        if (!a.$$destroyed)
                            return b = null, c = null, null != this.scope.models && this.scope.models.length > 0 && this.scope.markerModels.length > 0 ? h.promiseLock(this, m.promiseTypes.update, "pieceMeal", function (a) {
                                return b = a
                            }, function (d) {
                                return function () {
                ...
                return q = function (c) {
                    ...
                    return d(q, c), q.include(e), q.prototype.go = function (a) {
                            ...
                            return function () {
                                return p.promise(function () {
                                    ...
                                    return i.each(f.adds, function (d) {
                                        var f, g;
                                        if (f = null != (g = b.getItem(a, c, d[b.idKey])) ? g.gMarker : void 0, !f)
                        ...
                        if (void 0 !== this.contentKeys && 0 !== this.contentKeys.length) {
                            for (c = o(a), d = {}, h = this.contentKeys, f = 0, g = h.length; g > f; f++)
                                e = h[f], d[e] = b[e];
                            return c(d)
                        }
                    }, q
        ...
        b.module("uiGmapgoogle-maps.directives.api").service("uiGmapDragZoom", ["uiGmapCtrlHandle", "uiGmapPropertyAction", function (a, b) {
                return{restrict: "EMA", transclude: !0, template: '<div class="angular-google-map-dragzoom" ng-transclude style="display: none"></div>', require: "^uiGmapGoogleMap", scope: {keyboardkey: "=", options: "=", spec: "="}, controller: ["$scope", "$element", function (b, c) {
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapApiFreeDrawPolygons", ["uiGmapLogger", "uiGmapBaseObject", "uiGmapCtrlHandle", "uiGmapDrawFreeHandChildModel", "uiGmapLodash", function (b, c, e, f, g) {
                ...
                return h = function (c) {
                    ...
                    return d(h, c), h.include(e), h.prototype.restrict = "EMA", h.prototype.replace = !0, h.prototype.require = "^uiGmapGoogleMap", h.prototype.scope = {polygons: "=", draw: "=", revertmapoptions: "="}, h.prototype.link = function (a, c, d, e) {
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIControl", ["uiGmapBaseObject", "uiGmapLogger", "uiGmapCtrlHandle", function (a, b, d) {
                ...
                return e = function (a) {
                    function e() {
                        this.restrict = "EA", this.replace = !0, this.require = "^uiGmapGoogleMap", this.scope = {template: "@template", position: "@position", controller: "@controller", index: "@index"}, this.$log = b
                    }
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIMarker", ["uiGmapBaseObject", "uiGmapCtrlHandle", function (a, b) {
                ...
                return d = function (a) {
                    ...
                    return c(d, a), d.scopeKeys = {coords: "=coords", icon: "=icon", click: "&click", options: "=options", events: "=events", fit: "=fit", idKey: "=idkey", control: "=control"}, d.keys = _.keys(d.scopeKeys), d.extend(b), d
                }(a)
            }])
    }.call(this), function () {
        var a = {}.hasOwnProperty, c = function (b, c) {
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIPolyline", ["uiGmapGmapUtil", "uiGmapBaseObject", "uiGmapLogger", "uiGmapCtrlHandle", function (a, b, d, e) {
                ...
                return f = function (b) {
                    ...
                    return c(f, b), f.include(a), f.extend(e), f.prototype.restrict = "EMA", f.prototype.replace = !0, f.prototype.require = "^uiGmapGoogleMap", f.prototype.scope = {path: "=", stroke: "=", clickable: "=", draggable: "=", editable: "=", geodesic: "=", icons: "=", visible: "=", "static": "=", fit: "=", events: "="}, f.prototype.DEFAULTS = {}, f.prototype.$log = d, f
                }(b)
            }])
    }.call(this), function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapMap", ["$timeout", "$q", "uiGmapLogger", "uiGmapGmapUtil", "uiGmapBaseObject", "uiGmapCtrlHandle", "uiGmapIsReady", "uiGmapuuid", "uiGmapExtendGWin", "uiGmapExtendMarkerClusterer", "uiGmapGoogleMapsUtilV3", "uiGmapGoogleMapApi", "uiGmapEventsHelper", function (d, f, g, h, i, j, k, l, m, n, o, p, q) {
                ...
                return r = void 0, t = [o, m, n], s = function (f) {
                    ...
                    return e(i, f), i.include(h), i.prototype.restrict = "EMA", i.prototype.transclude = !0, i.prototype.replace = !1, i.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container"></div><div ng-transclude style="display: none"></div></div>', i.prototype.scope = {center: "=", zoom: "=", dragging: "=", control: "=", options: "=", events: "=", eventOpts: "=", styles: "=", bounds: "=", update: "="}, i.prototype.link = function (a, e, f) {
                        var h, i;
                        return h = [], a.$on("$destroy", function () {
                            ...
                            return function (j) {
                                ...
                                if (r = {mapTypeId: j.MapTypeId.ROADMAP}, C = k.spawn(), x = function () {
                                    return C.deferred.resolve({instance: C.instance, map: E})
                                }, !i.validateCoords(a.center))
                                    return void g.error("angular-google-maps: could not find a valid center property");
                                if (!b.isDefined(a.zoom))
                                    return void g.error("angular-google-maps: map zoom property not set");
                                if (p = b.element(e), p.addClass("angular-google-map"), w = {options: {}}, f.options && (w.options = a.options), f.styles && (w.styles = a.styles), f.type && (D = f.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(D) ? w.mapTypeId = google.maps.MapTypeId[f.type.toUpperCase()] : g.error("angular-google-maps: invalid map type '" + f.type + "'")), u = b.extend({}, r, w, {center: i.getCoords(a.center), zoom: a.zoom, bounds: a.bounds}), E = new google.maps.Map(p.find("div")[1], u), E.uiGmap_id = l.generate(), o = !1, h.push(google.maps.event.addListenerOnce(E, "idle", function () {
                                    ...
                                    var b, c;
                                    if (!B)
                                        return a.zoom !== E.zoom ? (A = !0, d(function () {
                                    ...
                                    for (s in a.events)
                                        a.events.hasOwnProperty(s) && b.isFunction(a.events[s]) && m.push(google.maps.event.addListener(E, s, t(s)));
                                    h.concat(m)
                                }
                                return E.getOptions = function () {
                                    ...
                                    var b;
                                    if (null != E)
                                        return google.maps.event.trigger(E, "resize"), null != (null != a ? a.latitude : void 0) && null != (null != a ? a.latitude : void 0) ? (b = i.getCoords(a), i.isTrue(f.pan) ? E.panTo(b) : E.setCenter(b)) : void 0
                                    ...
                                    var d;
                                    if (b !== c && !y && (d = i.getCoords(a.center), d.lat() !== E.center.lat() || d.lng() !== E.center.lng()))
                                        return z = !0, o || (i.validateCoords(b) || g.error("Invalid center for newValue: " + JSON.stringify(b)), i.isTrue(f.pan) && a.zoom === E.zoom ? E.panTo(d) : E.setCenter(d)), z = !1
                                }, !0), a.$watch("zoom", function (b, c) {
                                    var e, f;
                                    if (!_.isEqual(b, c) && E.getZoom() !== a.zoom)
                                        return B = !0, d(function () {
                                            return E.setZoom(b), B = !1
                                        }, (null != (e = a.eventOpts) && null != (f = e.debounce) ? f.zoomMs : void 0) + 20, !1)
                                }), a.$watch("bounds", function (a, b) {
                                    var c, d, e;
                                    if (a !== b)
                                        return null == a.northeast.latitude || null == a.northeast.longitude || null == a.southwest.latitude || null == a.southwest.longitude ? void g.error("Invalid map bounds for new value: " + JSON.stringify(a)) : (d = new google.maps.LatLng(a.northeast.latitude, a.northeast.longitude), e = new google.maps.LatLng(a.southwest.latitude, a.southwest.longitude), c = new google.maps.LatLngBounds(e, d), E.fitBounds(c))
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapMarkers", ["uiGmapIMarker", "uiGmapPlural", "uiGmapMarkersParentModel", "uiGmap_sync", "uiGmapLogger", function (a, b, d, e, f) {
                ...
                return g = function (e) {
                    function g() {
                        g.__super__.constructor.call(this), this.template = '<span class="angular-google-map-markers" ng-transclude></span>', b.extend(this, {doRebuildAll: "=dorebuildall", doCluster: "=docluster", clusterOptions: "=clusteroptions", clusterEvents: "=clusterevents", modelsByRef: "=modelsbyref"}), f.info(this)
                    }
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPlural", [function () {
                return{extend: function (a, b) {
                        return _.extend(a.scope || {}, b || {}, {idKey: "=idkey", doRebuildAll: "=dorebuildall", models: "=models", chunk: "=chunk"})
                    }}
            }])
    }.call(this), function () {
        var a = function (a, b) {
        ...
        b.module("uiGmapgoogle-maps").directive("uiGmapSearchBox", ["uiGmapGoogleMapApi", "uiGmapLogger", "uiGmapSearchBoxParentModel", "$http", "$templateCache", "$compile", function (c, d, e, f, g, h) {
                ...
                return new (i = function () {
                    function i() {
                        this.link = a(this.link, this), this.$log = d, this.restrict = "EMA", this.require = "^uiGmapGoogleMap", this.priority = -1, this.transclude = !0, this.template = "<span class='angular-google-map-search' ng-transclude></span>", this.replace = !0, this.scope = {template: "=template", events: "=events", position: "=?position", options: "=?options", parentdiv: "=?parentdiv"}
                    }
                ...
                b.prototype = new google.maps.OverlayView, b.prototype.createInfoBoxDiv_ = function () {
                    ...
                    var c = function (a) {
                        ...
                        if (document.defaultView && document.defaultView.getComputedStyle) {
                            if (b = a.ownerDocument.defaultView.getComputedStyle(a, ""))
                                return d.top = parseInt(b.borderTopWidth, 10) || 0, d.bottom = parseInt(b.borderBottomWidth, 10) || 0, d.left = parseInt(b.borderLeftWidth, 10) || 0, d.right = parseInt(b.borderRightWidth, 10) || 0, d
                        } else if (document.documentElement.currentStyle && a.currentStyle)
                            return d.top = parseInt(c(a.currentStyle.borderTopWidth), 10) || 0, d.bottom = parseInt(c(a.currentStyle.borderBottomWidth), 10) || 0, d.left = parseInt(c(a.currentStyle.borderLeftWidth), 10) || 0, d.right = parseInt(c(a.currentStyle.borderRightWidth), 10) || 0, d;
                    ...
                    var g = function (b) {
                        var c = 0, d = 0;
                        return b = b || a.event, "undefined" != typeof b.pageX ? (c = b.pageX, d = b.pageY) : "undefined" != typeof b.clientX && (c = b.clientX + e.x, d = b.clientY + e.y), {left: c, top: d}
                    }, h = function (b) {
                    ...
                    b.prototype.init_ = function (b, c) {
                        var e, g = this;
                        for (this.map_ = b, c = c || {}, this.key_ = c.key || "shift", this.key_ = this.key_.toLowerCase(), this.borderWidths_ = d(this.map_.getDiv()), this.veilDiv_ = [], e = 0; 4 > e; e++)
                            this.veilDiv_[e] = document.createElement("div"), this.veilDiv_[e].onselectstart = function () {
                                return!1
                            }, i(this.veilDiv_[e].style, {backgroundColor: "gray", opacity: .25, cursor: "crosshair"}), i(this.veilDiv_[e].style, c.paneStyle), i(this.veilDiv_[e].style, c.veilStyle), i(this.veilDiv_[e].style, {position: "absolute", overflow: "hidden", display: "none"}), "shift" === this.key_ && (this.veilDiv_[e].style.MozUserSelect = "none"), j(this.veilDiv_[e]), "transparent" === this.veilDiv_[e].style.backgroundColor && (this.veilDiv_[e].style.backgroundColor = "white", j(this.veilDiv_[e], 0)), this.map_.getDiv().appendChild(this.veilDiv_[e]);
                        ...
                        var c;
                        if (b = b || a.event, c = b.shiftKey && "shift" === this.key_ || b.altKey && "alt" === this.key_ || b.ctrlKey && "ctrl" === this.key_, !c)
                            switch (b.keyCode) {
                                case 16:
                                    "shift" === this.key_ && (c = !0);
                                    break;
                        ...
                        if (this.map_ && this.hotKeyDown_ && this.isMouseOnMap_()) {
                            ...
                            if (this.mapWidth_ = b.offsetWidth - (this.borderWidths_.left + this.borderWidths_.right), this.mapHeight_ = b.offsetHeight - (this.borderWidths_.top + this.borderWidths_.bottom), this.activatedByControl_) {
                                ...
                                for (this.veilDiv_[0].style.top = "0px", this.veilDiv_[0].style.left = "0px", this.veilDiv_[0].style.width = c + "px", this.veilDiv_[0].style.height = this.mapHeight_ + "px", this.veilDiv_[1].style.top = "0px", this.veilDiv_[1].style.left = c + e + "px", this.veilDiv_[1].style.width = this.mapWidth_ - (c + e) + "px", this.veilDiv_[1].style.height = this.mapHeight_ + "px", this.veilDiv_[2].style.top = "0px", this.veilDiv_[2].style.left = c + "px", this.veilDiv_[2].style.width = e + "px", this.veilDiv_[2].style.height = d + "px", this.veilDiv_[3].style.top = d + f + "px", this.veilDiv_[3].style.left = c + "px", this.veilDiv_[3].style.width = e + "px", this.veilDiv_[3].style.height = this.mapHeight_ - (d + f) + "px", a = 0; a < this.veilDiv_.length; a++)
                                    this.veilDiv_[a].style.display = "block"
                            } else {
                                for (this.veilDiv_[0].style.left = "0px", this.veilDiv_[0].style.top = "0px", this.veilDiv_[0].style.width = this.mapWidth_ + "px", this.veilDiv_[0].style.height = this.mapHeight_ + "px", a = 1; a < this.veilDiv_.length; a++)
                                    this.veilDiv_[a].style.width = "0px", this.veilDiv_[a].style.height = "0px";
                        ...
                        if (this.mousePosn_ = g(a), this.dragging_) {
                            ...
                            this.mouseDown_ || (this.mapPosn_ = h(this.map_.getDiv()), this.setVeilVisibility_())
                        ...
                        if (b) {
                            ...
                            for (this.getDiv().removeChild(b.boxDiv_), a = 0; a < b.veilDiv_.length; a++)
                    ...
                    for (b = 0; b < this.clusters_.length; b++)
                        d = this.clusters_[b], f = d.getCenter(), f && (c = this.distanceBetweenPoints_(f, a.getPosition()), g > c && (g = c, h = d));
                    ...
                    var a;
                    for (this.labelDiv_.parentNode.removeChild(this.labelDiv_), this.eventDiv_.parentNode.removeChild(this.eventDiv_), a = 0; a < this.listeners_.length; a++)
                        google.maps.event.removeListener(this.listeners_[a])
        ...
        return b.m = a, b.c = c, b.p = "", b(0)
                ...
                b = function () {
                    ...
                    return a.prototype.addNode = function (a) {
                        ...
                        if (d = this._nodes[a]) {
                            f = d._outEdges;
                            for (e in f)
                                c.call(f, e) && this.removeEdge(a, e);
                            g = d._inEdges;
                            for (b in g)
                                c.call(g, b) && this.removeEdge(b, a);
                        ...
                        for (b in f)
                            c.call(f, b) && d.push(this.getEdge(b, a));
                        return d
                    }, a.prototype.getOutEdgesOf = function (a) {
                        var b, d, e, f;
                        b = this._nodes[a], d = [], f = null != b ? b._outEdges : void 0;
                        for (e in f)
                            c.call(f, e) && d.push(this.getEdge(a, e));
                        return d
                    }, a.prototype.getAllEdgesOf = function (a) {
                        var b, c, d, e, f, g, h;
                        if (c = this.getInEdgesOf(a), d = this.getOutEdgesOf(a), 0 === c.length)
                            return d;
            ...
            (function () {
                ...
                b = function () {
                    function a(a) {
                        var b, c, d, e, f, g;
                        for (null == a && (a = []), this._data = [void 0], d = 0, f = a.length; f > d; d++)
                            c = a[d], null != c && this._data.push(c);
                        if (this._data.length > 1)
                            for (b = e = 2, g = this._data.length; g >= 2?g > e:e > g; b = g >= 2?++e:--e)
                                this._upHeap(b);
                    ...
                    return a.prototype.add = function (a) {
                        ...
                        if (1 !== this._data.length)
                            return this.size--, 2 === this._data.length ? this._data.pop() : (a = this._data[1], this._data[1] = this._data.pop(), this._downHeap(), a)
                    }, a.prototype.peekMin = function () {
                        return this._data[1]
                    }, a.prototype._upHeap = function (a) {
                        var b, c;
                        for (b = this._data[a]; this._data[a] < this._data[d(a)] && a > 1; )
                            c = [this._data[d(a)], this._data[a]], this._data[a] = c[0], this._data[d(a)] = c[1], a = d(a)
                    }, a.prototype._downHeap = function () {
                        var a, b, d;
                        for (a = 1; c(a < this._data.length) && (b = c(a), b < this._data.length - 1 && this._data[e(a)] < this._data[b] && (b = e(a)), this._data[b] < this._data[a]); )
                            d = [this._data[a], this._data[b]], this._data[b] = d[0], this._data[a] = d[1], a = b
                    }, a
                }(), d = function (a) {
                    return a >> 1
                }, c = function (a) {
            ...
            (function () {
                ...
                b = function () {
                    function a(a) {
                        var b, c, d;
                        for (null == a && (a = []), this.head = {prev:void 0, value:void 0, next:void 0}, this.tail = {prev:void 0, value:void 0, next:void 0}, this.size = 0, c = 0, d = a.length; d > c; c++)
                            b = a[c], this.add(b)
                    }
                    return a.prototype.at = function (a) {
                        ...
                        if (-this.size <= a && a < this.size) {
                            if (a = this._adjust(a), 2 * a < this.size)
                                for (b = this.head, c = d = 1; a >= d; c = d += 1)
                                    b = b.next;
                            else
                                for (b = this.tail, c = e = 1, f = this.size - a - 1; f >= e; c = e += 1)
                                    b = b.prev;
                            return b
                        }
                        ...
                        var b;
                        if (null != a) {
                            for (b = this.head; b && b.value !== a; )
                                b = b.next;
                            if (b)
                                return 1 === this.size ? this.head.value = this.tail.value = void 0 : b === this.head ? (this.head = this.head.next, this.head.prev = void 0) : b === this.tail ? (this.tail = this.tail.prev, this.tail.next = void 0) : (b.prev.next = b.next, b.next.prev = b.prev), this.size--, a
                        }
                    }, a.prototype.indexOf = function (a, b) {
                        var c, d;
                        if (null == b && (b = 0), null == this.head.value && !this.head.next || b >= this.size)
                            return-1;
                        for (b = Math.max(0, this._adjust(b)), c = this.at(b), d = b; c && c.value !== a; )
                            c = c.next, d++;
            ...
            (function () {
                ...
                b = function () {
                    ...
                    return a.prototype.enqueue = function (a) {
                        ...
                        var a;
                        if (0 !== this.size)
                            return this.size--, a = this._content[this._dequeueIndex], this._dequeueIndex++, 2 * this._dequeueIndex > this._content.length && (this._content = this._content.slice(this._dequeueIndex), this._dequeueIndex = 0), a
            ...
            (function () {
                ...
                c = 0, d = 1, e = 2, h = 3, f = 1, b = 2, g = function () {
                    function a(a) {
                        var b, c, d;
                        for (null == a && (a = []), this._root, this.size = 0, c = 0, d = a.length; d > c; c++)
                            b = a[c], null != b && this.add(b)
                    }
                    return a.prototype.add = function (a) {
                        var g, l, m, n;
                        if (null != a) {
                        ...
                        if (c._left && c._right && (e = n(c._right), c.value = e.value, c = e), e = c._left || c._right, e || (e = {color: b, _right: void 0, _left: void 0, isLeaf: !0}), e._parent = c._parent, null != (g = c._parent) && (g[l(c)] = e), c._color === b)
                            if (e._color === f)
                                e._color = b, e._parent || (this._root = e);
                            else
                                for (; ; ) {
                                    if (!e._parent) {
                                    ...
                                    if (d = o(e), (null != d ? d._color : void 0) === f && (e._parent._color = f, d._color = b, k(e) ? this._rotateLeft(e._parent) : this._rotateRight(e._parent)), d = o(e), e._parent._color !== b || d && (d._color !== b || d._left && d._left._color !== b || d._right && d._right._color !== b)) {
                                        ...
                                        null != d && (d._color = f), e.isLeaf && (e._parent[l(e)] = void 0), e = e._parent
                                }
            ...
            (function () {
                ...
                b = c(6), e = "end", d = function () {
                    ...
                    return a.prototype.add = function (a) {
                        var b, c, d, f;
                        if (null != a) {
                            for (this.size++, b = this._root, d = 0, f = a.length; f > d; d++)
                                c = a[d], null == b[c] && (b[c] = {}), b = b[c];
                            return b[e] = !0, a
                        }
                    }, a.prototype.has = function (a) {
                        var b, c, d, f;
                        ...
                        if (null == a)
                            return"";
                        for (b = this._root, d = "", e = 0, f = a.length; f > e && (c = a[e], null != b[c]); e++)
                            d += c, b = b[c];
                        return d
                        ...
                        if (null != a) {
                            ...
                            if (b[e]) {
                                if (this.size--, delete b[e], f(b, 1))
                                    return a;
                                for (c = i = k = g.length - 1; (1 >= k?1 >= i:i >= 1) && !f(g[c][1], 1); c = 1 >= k?++i:--i)
            ...
            return{init: _.once(function () {
                    (function () {
                        var c = {}.hasOwnProperty, d = function (a, b) {
                            function d() {
                                this.constructor = a
                            }
                            for (var e in b)
                        ...
                        a.NgMapCluster = function (c) {
                            ...
                            return d(c, b), c.prototype.clearMarkers = function () {
                                ...
                                if (this.ready_) {
                                    ...
                                    for (b = a; g > b; b++)
                                        c = h[b], !c.isAdded && this.isMarkerInBounds_(c, f) && (!this.ignoreHidden_ || this.ignoreHidden_ && c.getVisible()) && this.addToClosestCluster_(c);
